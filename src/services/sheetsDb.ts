...
export const SHEETS_DATABASE_SCHEMAS: SheetSchema[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: 'bankName', type: 'string', description: 'Bank institution name', sample: 'Millennium BIM', required: false },
      { name: 'accountHolder', type: 'string', description: 'Beneficiary / Account Holder', sample: 'STech Global Lda', required: false },
      { name: 'accountNumber', type: 'string', description: 'Bank account number', sample: '1029384756', required: false },
      { name: 'ibanOrNib', type: 'string', description: 'NIB / IBAN for wire transfer', sample: '0001 0000 1234 5678 9012 3', required: false },
      { name: 'swiftCode', type: 'string', description: 'SWIFT / BIC code', sample: 'BIMMMZM', required: false },
      { name: 'branchName', type: 'string', description: 'Branch or agency name', sample: 'Maputo Central', required: false },
      ...
      { name: 'notes', type: 'string', description: 'Internal ledger notes', sample: 'Primary operating account', required: false },
    ],
  },
  {
